...
export const MacbookStatic = ({
  ...
  return (
    <div className="flex shrink-0 transform flex-col items-center py-0 [perspective:800px]">
      ...
      {/* Lid */}
      <Lid src={src} videoSrc={videoSrc}>{children}</Lid>
      {/* Base area */}
      ...
      >
        ...
        >
          {children ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#0f1220] to-[#1a1a2e]">
              <span className="font-mono text-xs text-white/20">video.mp4</span>
            </div>
          )}
        </div>
      </div>
